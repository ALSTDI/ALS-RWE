...
You have fellows spanning computer science and data analytics through OBGYN and other clinical backgrounds. The design goal is that both ends of that range stay engaged: the clinical fellows are not lost in the tooling, and the technical fellows are not bored by the vocabulary basics. The running example does that work, because everyone can reason about diabetes and pregnancy, and the feasibility logic is new to nearly all of them regardless of background.
